...
import com.example.test.ScaleMarkScroller.ScrollingListener;
...
public class ScaleMarkView extends SurfaceView implements SurfaceHolder.Callback, ScrollingListener {
    ...
    /** 默认的值 */
    private double mDefaultValue = 100.0;
    private SurfaceHolder mHolder;

    private int mMaxMarkValue = 1000;
...
//    private Paint mTest = new Paint();
    ...
    public BigDecimal getCurrentValue() {
        computeMarkValue();
        return getValueFormat(mCurrentBigMarkValue, mCurrentSmallMarkValue, 100);
